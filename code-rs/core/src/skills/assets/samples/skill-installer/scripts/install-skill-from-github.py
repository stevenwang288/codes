#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into ~/.codes/skills."""
...
def _codes_home() -> str:
    return os.environ.get("CODES_HOME", os.path.expanduser("~/.codes"))
...
def _default_dest() -> str:
    return os.path.join(_codes_home(), "skills")
