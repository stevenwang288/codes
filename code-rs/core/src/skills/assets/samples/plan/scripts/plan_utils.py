...
def get_codes_home() -> Path:
    """Return CODES_HOME if set, else ~/.codes."""
    return Path(os.environ.get("CODES_HOME", "~/.codes")).expanduser()


def get_plans_dir() -> Path:
    return get_codes_home() / "plans"
